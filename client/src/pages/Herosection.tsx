...
export const Herosection = (): JSX.Element => {
  ...
  const gridCellTypes = {
    ...
    brown:
      "[border-image:linear-gradient(137deg,rgba(2,137,1,0.01)_0%,rgba(33,55,1,0.02)_100%)_1]",
  };
  ...
  const partners = [
    ...
    },
    {
      ...
      className: "w-[55.81px] h-8 mt-[-526.65px] ml-[-523.00px]",
    },
  ];
  ...
  return (
    <div className="flex flex-col items-center gap-24 pt-[124px] pb-12 px-16 relative bg-[#000d19]">
      {/* Background grid */}
        ...
        <div className="relative w-[1964px] h-[1178px]">
          <div className="absolute w-[1656px] h-[1163px] top-0 left-[156px]">
            <div className="relative w-[1693px] h-[1223px] left-[-37px]">
              {/* Grid background - using a more efficient approach with rows */}
              <div className="flex flex-col w-[1656px] items-start absolute top-0 left-[37px]">
                {/* Generating 13 rows of grid cells */}
                {Array(13)
                  .fill(0)
                  .map((_, rowIndex) => (
                    <div
                    ...
                    >
                      {Array(14)
                        ...
                        .map((_, dotIndex) => {
                          ...
                          else if (colIndex >= 8 && colIndex <= 12)
                            dotType = dotTypes.green;

                          // Add special classes for first and last dots in column
                          const isFirst = dotIndex === 0;
                          const isLast = dotIndex === 13;
      ...
      <div className="flex flex-col items-start justify-center gap-2.5 px-24 py-0 relative self-stretch w-full flex-[0_0_auto]">
        <div className="flex items-center gap-8 relative self-stretch w-full flex-[0_0_auto]">
          ...
          <div className="flex flex-col max-w-[600px] items-start gap-6 relative flex-1 grow">
            ...
            <Button className="flex items-center justify-center gap-2.5 px-6 py-4 relative self-stretch w-full flex-[0_0_auto] bg-[#d08f15] hover:bg-[#e79715] rounded-lg overflow-hidden border border-solid border-[#e79715] text-[#000d19] font-medium">
              Join the waitlist
            </Button>
            ...
            <div className="inline-flex items-center gap-2 relative flex-[0_0_auto]">
              ...
              <div className="relative w-fit [font-family:'Circular_Std-BookItalic',Helvetica] font-normal italic text-[#e8e8e8] text-base tracking-[0.32px] leading-[19.8px] whitespace-nowrap">
      ...
      <div className="flex flex-col items-center gap-12 relative self-stretch w-full flex-[0_0_auto]">
        ...
        <div className="inline-flex flex-col items-center gap-3 relative flex-[0_0_auto] ml-[-64.00px] mr-[-64.00px]">
          <div className="inline-flex items-center justify-center gap-2.5 pl-16 pr-0 py-0 relative flex-[0_0_auto]">
            <div className="relative w-fit mt-[-1.00px] [font-family:'Circular_Std-Book',Helvetica] font-normal text-gray-200 text-xl text-center tracking-[0] leading-8 whitespace-nowrap">
          ...
          <div className="flex w-[1440px] items-center justify-center gap-8 px-20 py-6 relative flex-[0_0_auto]">
            {partners.map((partner, index) => (
              <div
                key={`partner-${index}`}
                className={`flex w-48 items-center justify-center gap-2 relative ${
                  index === 0
                    ? "h-[34.88px] ml-[-352.00px]"
                    : index === 1
                      ? "h-[49.39px] ml-[-128.00px]"
                      : index === 7
                        ? "h-[56.35px] mr-[-128.00px]"
                        : index === 8
                          ? "h-[37.05px] mr-[-352.00px]"
                          : "h-[49.39px]"
                }`}
              >
                <img
