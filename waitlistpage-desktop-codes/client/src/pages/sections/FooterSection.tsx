    ...
    <footer className="flex flex-col w-full gap-12 pt-10 pb-8 px-16 bg-[#0d1117]">
      <div className="flex flex-col items-start gap-6 w-full">
        ...
        <div className="flex w-full gap-6">
          {/* Left column with tagline and GDPR badge */}
              ...
              >
                {product.logo ? (
                  <div className="flex items-center gap-1 h-6">
                    <img
                      className="w-[24.32px] h-6 ml-[-0.16px]"
                      alt="Figma logo"
                      src={product.logo}
                    />
                    <div
                  ...
                  <div
                    className={`${product.textColor} ${product.fontFamily || "[font-family:'Hardpixel-Regular',Helvetica]"} text-xl leading-[24.8px] font-normal tracking-[0] whitespace-nowrap`}
                  >
                    {product.name}
                  </div>
                )}
      ...
      <div className="flex items-center justify-between py-6 w-full">
        ...
        <div className="flex items-end gap-1.5">
          ...
          <div className="[font-family:'Nunito',Helvetica] font-normal text-xs tracking-[0] leading-3">
            <a
              href="https://privacy-policy"
              rel="noopener noreferrer"
              target="_blank"
              className="font-medium text-slate-400 leading-4 underline"
            >
              Privacy Policy
            </a>
