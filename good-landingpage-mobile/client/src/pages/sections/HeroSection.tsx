      ...
      <div className="absolute w-[2192px] h-[1152px] top-0 left-0">
        <div className="relative h-[1152px]">
          <div className="flex flex-col w-[1656px] items-start absolute top-0 left-0 opacity-70">
            {/* Grid rows - using map to generate grid cells */}
            {[
      ...
      <div className="flex flex-col items-start justify-end gap-11 relative self-stretch w-full flex-[0_0_auto]">
        ...
        <div className="items-start gap-5 flex flex-col relative self-stretch w-full flex-[0_0_auto]">
          <div className="flex flex-col items-start gap-3 relative self-stretch w-full flex-[0_0_auto]">
            <Badge
              variant="outline"
              className="p-3 bg-[#0d0d0d] border-[#ffffff1a] rounded-lg"
            >
              <span className="[font-family:'Nunito',Helvetica] font-normal text-[#dadada] text-xs text-center tracking-[0] leading-[14px] whitespace-nowrap">
                Used by 2,000+ Cybersecurity Enthusiasts
              </span>
            </Badge>

            <h1 className="relative self-stretch [font-family:'Suisse_Intl-Bold',Helvetica] font-normal text-transparent text-[32px] tracking-[0] leading-8">
              <span className="font-bold text-[#fe6808] leading-[42.2px]">
                Master Cybersecurity
              </span>
              <span className="font-bold text-[#8bad84] leading-[0.1px]">
                {" "}
          ...
          <div className="flex items-center gap-3 relative self-stretch w-full flex-[0_0_auto]">
            <Button className="flex-1 px-6 py-3 bg-[#d08f15] hover:bg-[#b87d13] text-[#0f1626] rounded-lg shadow-[0px_1px_2px_#0000000d]">
              <span className="[font-family:'Circular_Std-Medium',Helvetica] font-medium text-base text-center tracking-[0.80px] leading-5">
                Get Started
              </span>
            </Button>
            ...
            <Button
              variant="outline"
              className="flex-1 gap-4 px-6 py-3 bg-[linear-gradient(270deg,rgba(29,46,72,0.09)_0%,rgba(67,98,145,0.03)_100%)] text-[#e8e8e8] border-none rounded-lg shadow-[0px_1px_2px_#0000000d]"
            >
              <span className="[font-family:'Circular_Std-Medium',Helvetica] font-medium text-lg text-center tracking-[0.80px] leading-6">
                Explore
              </span>
              <img
                className="w-5 h-5"
          ...
          <div className="flex items-center gap-2 relative self-stretch w-full flex-[0_0_auto]">
            <div className="inline-flex items-center relative flex-[0_0_auto]">
              ...
              <div className="flex w-11 h-11 items-center justify-center relative -ml-3 bg-[#272b2d] rounded-[100px] border-4 border-solid border-[#121212]">
                <div className="relative w-fit [font-family:'Circular_Std-Medium',Helvetica] font-medium text-white text-xs leading-4 whitespace-nowrap text-center tracking-[0]">
                  +200
                </div>
              </div>
            </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                <img
                  ...
                  src={feature.icon}
                />
                <div className="w-fit [font-family:'Nunito',Helvetica] font-normal text-sm leading-5 whitespace-nowrap relative mt-[-1.00px] text-[#f2ece8] tracking-[0]">
                  {feature.text}
                </div>
              </div>
            ))}
