        ...
        {featureCards.map((card, index) => (
          ...
          >
            <CardContent className="p-0">
              <div
                className="relative w-[324px] h-[180px] rounded-xl overflow-hidden"
                style={{
                  background: card.specialBg 
                    ? `linear-gradient(0deg,rgba(33,133,26,0.1) 0%,rgba(33,133,26,0.1) 100%), url(${card.image}) 50% 50% / cover`
